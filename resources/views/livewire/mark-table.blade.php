        ...
        <div class="row">
            ...
            <div class="col-md-2 select" name='select1'>
                <select wire:model="orderBy"
                    ...
                    id="grid-state">
                    <option data-test="maMH" value="maMH">Mã MH</option>
                    <option data-test="name" value="name">Tên</option>
                    <option data-test="so_tc" value="so_tc">Số TC</option>
                    <option data-test="mark_dec" value="mark_dec">Điểm</option>
                </select>
            ...
            <tbody>
                ...
                @foreach ($coursess as $course)
                    <tr>
                        ...
                        <td class="maMH">{{ $course->maMH }}</td>
                        <td class="name">{{ $course->name }}</td>
                        <td class="so_tc">{{ $course->so_TC }}</td>
                        <td class="mark_dec">{{ averageMark($course) }}</td>
